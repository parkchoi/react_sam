...
const portText=[
    {
        ...
        img:port01,
        img_alt:"code_99 팀",
        desc:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi dolorum consequatur perspiciatis temporibus deleniti eius nam animi impedit fugit sint consectetur ratione error, itaque commodi a ex enim adipisci. Reiciendis.",
...
const Port = () => {
    ...
    // sectionRef라는 변수를 생성하고 useRef훅으로 빈배열로 초기화
                ...
                <div className="port_wrap">
                    {portText.map((port,key)=>(
                        ...
                        >
                            ...
                            <a href={port.site} className='site'>사이트 보기</a>
                        </div>
                    ))}
                </div>
            </div>
